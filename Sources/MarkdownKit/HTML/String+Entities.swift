...
extension String {
  ...
  // Map named character references to characters;
  // for details see http://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references
  static let namedCharacterRefs: [String: Character] = [
    "&quot;"  : "\u{0022}",
    "&amp;"   : "\u{0026}",
    "&apos;"  : "\u{0027}",
    "&lt;"    : "\u{003C}",
    ...
    "&hearts;": "\u{2665}",
    "&diams;" : "\u{2666}",
    // needed for Windows-1252; see https://en.wikipedia.org/wiki/Windows-1252
    "&#128;"  : "\u{20AC}",
    "&#130;"  : "\u{201A}",
    "&#131;"  : "\u{0192}",
    "&#132;"  : "\u{201E}",
